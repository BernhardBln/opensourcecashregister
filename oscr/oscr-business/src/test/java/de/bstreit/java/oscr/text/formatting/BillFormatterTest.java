...
public class BillFormatterTest extends AbstractSpringTestWithContext {
	...
	@Inject
	private SimpleVATFinderDoNotUseInProduction vatFinder;

	@Inject
	private Currency defaultCurrency;

	@Value("sampleBill_inhouse_onlyOneVATClass_withVariation")
	...
	@Test
	@Transactional
	public void testSampleBill_inhouse_onlyOneVATClass() {
		// INIT
	...
	@Test
	@Transactional
	public void testSampleBill_inhouse_onlyOneVATClass_withVariation() {
	...
	private ProductOffer createOffer(String name, String price, TaxInfo taxInfo) {
		final Product product = new Product(name, null, null);

		if (taxInfo != null) {
			product.setOverridingTaxInfo(taxInfoRepository.findOne(taxInfo
					.getId()));
		}
