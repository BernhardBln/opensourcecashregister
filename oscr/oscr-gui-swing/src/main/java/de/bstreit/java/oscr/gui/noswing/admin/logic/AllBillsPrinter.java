...
@Named
public class AllBillsPrinter implements IAdminBean {
  ...
  public void performTask() {
    ...
    Collection<Bill> bills = billService.getAllBillsForAllDay(day);
  ...
  public String toString() {
    return "Print ALL bills (including customers and employees!)";
  }
