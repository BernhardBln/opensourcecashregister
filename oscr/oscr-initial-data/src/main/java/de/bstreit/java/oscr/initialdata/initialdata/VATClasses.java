...
public class VATClasses extends AbstractDataContainer<VATClass> {
	...
	public static final VATClass normalTax = new VATClass(
			"Normaler Steuersatz", new BigDecimal("19"),
			ValidityDates.VALID_FROM_DATE, ValidityDates.VALID_TO_DATE);

	public static final VATClass reducedTax = new VATClass(
			"Ermäßigter Steuersatz", new BigDecimal("7"),
			ValidityDates.VALID_FROM_DATE, ValidityDates.VALID_TO_DATE);
