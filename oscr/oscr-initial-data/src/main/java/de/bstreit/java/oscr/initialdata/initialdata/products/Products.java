...
public class Products {
	...
	public static final Product ESPRESSO = addProduct("Espresso",
			ContainerSizes.CUP_100_ML);
	public static final Product DOUBLE_ESPRESSO = addProduct("Double Espresso",
			ContainerSizes.CUP_100_ML);
	...
	public static final Product SINGLE_ESPRESSO_MACCHIATO = addProduct(
			"Single Espresso Macchiato", ContainerSizes.CUP_100_ML);
	public static final Product DOUBLE_ESPRESSO_MACCHIATO = addProduct(
			"Double Espresso Macchiato", ContainerSizes.CUP_100_ML);

	public static final Product CAPPUCCINO = addProduct("Cappuccino",
			ContainerSizes.CUP_200_ML);
	public static final Product DOUBLE_CAPPUCCINO = addProduct(
			"Double Cappuccino", ContainerSizes.CUP_200_ML);

	public static final Product FLAT_WHITE = addProduct(
			"Flat White (Double Espr.)", ContainerSizes.CUP_200_ML);

	public static final Product LATTE_MACCHIATO = addProduct("Latte Macchiato",
			ContainerSizes.CUP_200_ML);

	public static final Product KAKAO = addProduct("Hot Chocolate",
			ContainerSizes.CUP_200_ML);
	public static final Product SINGLE_SCHOKO_CAPPUCCINO = addProduct(
			"Hot Chocolate + Espresso", ContainerSizes.CUP_300_ML);

	public static final Product ICED_DOUBLE_CAPPUCCINO = addProduct("Iced Cappuccino");

	public static final Product MINT_TEA = addProduct("Mint Tea",
			ContainerSizes.CUP_200_ML);
	public static final Product LINDENBLUETEN = addProduct("Lindenblüten",
			ContainerSizes.CUP_200_ML);
	...
	private static Product addProduct(String productName) {
		return new Product(productName, ValidityDates.VALID_FROM_DATE,
