...
import de.bstreit.java.oscr.products.Extra;
...
public class AbstractPersistentObjectWithContinuanceTest {
	 ...
	 * {@link AbstractPersistentObjectWithContinuance} are sufficient for equality
	 * and equal hashcodes.
	 */
	@Test
	 ...
	 * <b>this, however, is not guaranteed and in an unlikely case it might happen
	 * that the test fails here</b>. But the chance is very low, and with that
	 * test, we check that hashcode is used properly in order to gain performance
	 * when using hashed collections.
	 * </p>
	 */
	@Test
	public void equalsAndHashCodeOfSubclassesAreRespected_notEqualOffers_subclassNotEqual() {
		final ProductOffer offer1 = new ProductOffer(product1, null, date1, date2);
		final ProductOffer offer2 = new ProductOffer(product2, null, date1, date2);
	...
	public void equalsAndHashCodeOfSubclassesAreRespected_notEqualOffers_superclassNotEqual() {
		final ProductOffer offer1 = new ProductOffer(product1, null, date1, date2);
		final ProductOffer offer2 = new ProductOffer(product1, null, date3, date4);
	...
	public void equalsAndHashCodeOfSubclassesAreRespected_notEqualOffers_bothNotEqual() {
		final ProductOffer offer1 = new ProductOffer(product1, null, date1, date2);
		final ProductOffer offer2 = new ProductOffer(product2, null, date3, date4);
	 ...
	 * @param o2
	 */
	private void checkHashcodesNotEqualWithWarning(final Object o1, final Object o2) {
		Assert
		    .assertNotEquals(
